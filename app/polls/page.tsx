...
export default function PollsPage() {
  ...
  const handlePlaceStake = () => {
    ...
    const timeLeft = new Date(selectedPoll?.endTime ?? 0).getTime() - Date.now();
    if (timeLeft <= 0) {
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3'>
              ...
              <div className='flex gap-2'>
                ...
                >
                  ...
                  <SelectContent className='bg-black border-white/10 rounded-xl'>
                    <SelectItem value='createdAt' className='text-white hover:bg-white/10'>
                      Latest
                    </SelectItem>
                    <SelectItem value='endTime' className='text-white hover:bg-white/10'>
                      Ending Soon
                    </SelectItem>
                    <SelectItem value='totalStakeAmount' className='text-white hover:bg-white/10'>
                      Pool Size
                    </SelectItem>
                    <SelectItem value='totalParticipants' className='text-white hover:bg-white/10'>
                      Popular
                    </SelectItem>
                  </SelectContent>
                </Select>
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='flex gap-2'>
                      {poll.status === 'active' && (
                        ...
                        >
                          {isExpired ? 'Poll Ended' : hasUserStaked(poll) ? 'Already Staked' : 'Place Your Stake'}
          ...
          <div className='mt-4 max-h-[60vh] overflow-y-auto pr-2'>
            <div className='space-y-3'>
              {selectedPoll?.options.map((option: any, index: number) => {
                ...
                const percentage = statisticsOption?.percentage !== undefined
          ...
          <div className='flex gap-3 max-sm:flex-col mt-6'>
            {selectedPoll?.status === 'active' && (
              ...
              >
                ...
                {hasUserStaked(selectedPoll) ? 'Already Staked' : 'Place Your Stake'}
              </Button>
            )}
            <Button
