        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20'>
          <div className='text-center'>
            ...
            <p className='text-base xs:text-lg sm:text-xl md:text-2xl text-gray-300 mb-3 sm:mb-4 max-w-3xl mx-auto px-4 sm:px-0'>
              Predict entertainment show outcomes and events. Win money from other players!
            </p>
            {totalParticipants > 0 ? (
              <p className='text-base sm:text-lg text-gray-400 mb-2'>
                Join {totalParticipants.toLocaleString()}+ players competing for real money daily!
              </p>
            ) : (
              <p className='text-base sm:text-lg text-gray-400 mb-2'>
                  ...
                  >
                    ...
                    <CardContent>
                      <div className='space-y-3'>
                        ...
                        {poll.totalStakeAmount !== undefined && poll.totalStakeAmount > 0 && (
                        ...
                        {poll.totalParticipants !== undefined && poll.totalParticipants > 0 && (
                          <div className='flex items-center justify-between'>
                            ...
                            <span className='text-white font-bold'>{poll.totalParticipants}</span>
                          </div>
                        )}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 xs:gap-4 sm:gap-6'>
            <div className='text-center'>
              ...
              <p className='text-white font-bold text-sm sm:text-base'>Fair Play</p>
              <p className='text-gray-500 text-xs sm:text-sm'>Player vs Player</p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-white font-bold text-sm sm:text-base'>Secure</p>
            ...
            <div className='text-center'>
              ...
              <p className='text-white font-bold text-sm sm:text-base'>Instant Wins</p>
              <p className='text-gray-500 text-xs sm:text-sm'>Get losers&apos; money</p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-white font-bold text-sm sm:text-base'>24/7 Support</p>
              <p className='text-gray-500 text-xs sm:text-sm'>Always here for you</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className='py-8 xs:py-12 sm:py-16 lg:py-20 relative'>
        ...
        <div className='relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-base sm:text-lg md:text-xl text-gray-300 mb-4 sm:mb-6 md:mb-8 max-w-2xl mx-auto px-4 sm:px-0'>
            Beat other players with your entertainment predictions. Start winning
            start competing!
          </p>
